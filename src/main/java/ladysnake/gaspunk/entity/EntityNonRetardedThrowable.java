...
/**
 * Basically the throwable class but with a collision check
 */
public abstract class EntityNonRetardedThrowable extends Entity implements IProjectile {
    protected int xTile;
    protected int yTile;
    protected int zTile;
    ...
    public EntityNonRetardedThrowable(World worldIn) {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityNonRetardedThrowable(World worldIn, double x, double y, double z) {
        this(worldIn);
