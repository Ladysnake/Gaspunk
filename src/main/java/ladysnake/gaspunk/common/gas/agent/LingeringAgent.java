...
public class LingeringAgent extends GasAgent {
    ...
    private Identifier sicknessId;
    private ISickness sickness;

    public LingeringAgent(boolean toxic, boolean ignoreBreath, Identifier sickness) {
        super(toxic);
     ...
     */
    public void addEffectToEntity(LivingEntity entity, float concentration, float potency) {
